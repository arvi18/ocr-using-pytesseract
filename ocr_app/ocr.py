...
image_file = "./data/badslide.jpg"
img = cv2.imread(image_file)
img=cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)

img=cv2.threshold(img, 210, 230, cv2.THRESH_BINARY)
display(image_file)
ocr=pytesseract.image_to_string(image_file)
print('ocr:', ocr)
...
print('ocr:', ocr)
# print('inverted_image:', inverted_image)
...
# ocr=pytesseract.image_to_string(no_noise)
print('ocr:', ocr)
...
ocr=pytesseract.image_to_string(eroded_image)
print('ocr:', ocr)
...
ocr=pytesseract.image_to_string(dilated_image)
print('ocr:', ocr)
cv2.imwrite("temp/dilated_image.jpg", dilated_image)

display("temp/dilated_image.jpg")

# border shuold be eliminatd first
new = cv2.imread("data/page_01_rotated.JPG")
ocr=pytesseract.image_to_string(new)
print('ocr:', ocr)
...
fixed = deskew(new)
ocr=pytesseract.image_to_string(fixed)
print('ocr:', ocr)
...
ocr=pytesseract.image_to_string(no_borders)
print('ocr:', ocr)
